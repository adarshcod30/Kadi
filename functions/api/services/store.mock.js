...
function load() {
  ...
  const pendencySetMeta = readJson('pendency_set_meta', null);
  const pendencyCurrent = readJson('pendency_current', []);
  ...
  DB = {
    ...
    socio, forecast, trainingSetMeta, offenderSetMeta, pendencySetMeta, pendencyCurrent,
