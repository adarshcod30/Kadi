...
| **Predictive risk scoring / forecast** | ✅ done | 3-month, MAPE 3.9% |
...
- **Cases** — state: all 40,836. District: that district's cases **plus cases linked into
...
**The honest problem:** entity resolution merges 36,890 accused records into 36,289 identities
